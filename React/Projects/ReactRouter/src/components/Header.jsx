...
import { useLocation, useNavigate } from 'react-router-dom'     //Just alternative of Link/NavLink

// Link → used for navigation without page reload (SPA advantage)
// NavLink → same as Link + highlights active/current page
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                {/* useNavigate → navigation using function */}
                                {/* useLocation → manual active check (replacement for isActive) */}
                                <button
                                    onClick={() => navigate('/about')}
                                    className={`block py-2 pr-4 pl-3 duration-200 ${location.pathname === '/about' ? "text-orange-700" : "text-gray-700"} 
